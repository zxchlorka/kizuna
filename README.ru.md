...
Связывайте данные между источниками — колонку Postgres с паттерном ключей Redis, поле Kafka-сообщения со строкой в Postgres — и переходите между ними в один клик. Это и есть те самые 絆 (кидзуна, «узы»), в честь которых названо приложение.
