...
![Follow a link](.github/assets/cross-source-link.png)

Link data across sources — a Postgres column to a Redis key pattern, a Kafka message field to a Postgres row. Right-click a row and the linked record opens in one click.

![Manage links in Settings](.github/assets/links-settings.png)

Links can be edited or removed in Settings.
